...
SWIFT_MODULE_NAMESPACE_PUSH("PopupCalendar")
@protocol CalendarViewDelegate;
@class NSBundle;
@class NSCoder;

SWIFT_CLASS("_TtC13PopupCalendar22CalendarViewController")
@interface CalendarViewController : UIViewController
@property (nonatomic, strong) id <CalendarViewDelegate> _Nullable delegate SWIFT_DEPRECATED_OBJC("Swift property 'CalendarViewController.delegate' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Class Initialization Helper
+ (CalendarViewController * _Nonnull)create SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'CalendarViewController.create()' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)viewDidLoad;
...
SWIFT_PROTOCOL("_TtP13PopupCalendar20CalendarViewDelegate_")
@protocol CalendarViewDelegate
- (void)didSelectDatesWithCheckinDate:(NSDate * _Nonnull)checkinDate checkoutDate:(NSDate * _Nonnull)checkoutDate;
@end
...
SWIFT_CLASS("_TtC13PopupCalendar19JTAppleCalendarView")
...
@interface JTAppleCalendarView (SWIFT_EXTENSION(PopupCalendar))
...
@interface JTAppleCalendarView (SWIFT_EXTENSION(PopupCalendar)) <UIScrollViewDelegate>
...
@interface JTAppleCalendarView (SWIFT_EXTENSION(PopupCalendar)) <UICollectionViewDataSource, UICollectionViewDelegate>
...
SWIFT_CLASS("_TtC13PopupCalendar11JTAppleCell")
...
SWIFT_CLASS("_TtC13PopupCalendar29JTAppleCollectionReusableView")
