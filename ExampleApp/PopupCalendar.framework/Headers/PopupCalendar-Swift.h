...
+ (CalendarViewController * _Nonnull)create SWIFT_WARN_UNUSED_RESULT;
- (void)viewDidLoad;
...
@interface CalendarViewController (SWIFT_EXTENSION(PopupCalendar))
@end
...
@interface JTAppleCalendarView (SWIFT_EXTENSION(PopupCalendar)) <UICollectionViewDelegate, UICollectionViewDataSource>
...
///
- (void)reloadDataWithCompletionHandler:(void (^ _Nullable)(void))completionHandler;
...
@interface UICollectionViewFlowLayout (SWIFT_EXTENSION(PopupCalendar))
@end
