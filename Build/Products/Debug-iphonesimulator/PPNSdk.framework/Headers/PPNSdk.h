...
//! Project version number for PPNSdk.
FOUNDATION_EXPORT double PPNSdkVersionNumber;

//! Project version string for PPNSdk.
FOUNDATION_EXPORT const unsigned char PPNSdkVersionString[];
